 ...
 */
var karaokeSongTitles = [String]()

karaokeSongTitles.append("Nothing else matters")
karaokeSongTitles.append("Fuel")
karaokeSongTitles.append("Starboy")
/*:
 - callout(Exercise): 
 ...
 */
let enthusiasticSongList = ["Baby one more time", "Sexy back", "Better work, bitch"]

karaokeSongTitles += enthusiasticSongList
/*:
 - callout(Exercise): 
 ...
 */
for title in karaokeSongTitles {
    print("Next song is \(title).")
}
/*:
 - callout(Exercise): 
 After the loop has called everyone up to sing, use the `removeAll` method on the song list to clear out all the past songs.
 */
karaokeSongTitles.removeAll()
karaokeSongTitles
/*:
